  ...
  return (
    <motion.div className="w-full grid grid-cols-1  md:grid-cols-2 gap-4 ">
      <div className="flex flex-col items-start justify-start gap-6">
        ...
        Experience culinary convenience with our seamless food delivery service. From your favorite local eateries to popular chains, enjoy delicious meals delivered straight to your door
        </p>
        <motion.button
          {...buttonClcik}
